    ...
    public function handle()
    {
        ...
        $botman->hears('{message}', function ($botman, $message) {
            $questions = [
                ...
                'who are the sip coordinators?' => "For Computer Science, the SIP coordinator is Sir Arnold Manlangit. For Information Technology, it is Ma'am Merlijoy M. Jamero. For Information Systems, it is Ma'am Marie Stella Gerodias.",
